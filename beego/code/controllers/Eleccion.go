...
// @Success 200 Eleccion models.Eleccion
...
func (j *EleccionController) Get() {
	...
	session, _ := db.GetSession()
	if id != "" {
		eleccion, err := models.GetEleccionById(session,id)
		if err != nil {
...
// @Failure 403 body is empty
// @router / [options]
func (j *EleccionController) Options() {
	j.Data["json"] = "success!"
	j.ServeJSON()
}
...
func (j *EleccionController) EleccionDeleteOptions() {
	j.Data["json"] = "success!"
	j.ServeJSON()
}