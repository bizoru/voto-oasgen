...
// @Success 200 Ponderacion models.Ponderacion
...
func (j *PonderacionController) Get() {
	...
	session, _ := db.GetSession()
	if id != "" {
		ponderacion, err := models.GetPonderacionById(session,id)
		if err != nil {
...
// @Failure 403 body is empty
// @router / [options]
func (j *PonderacionController) Options() {
	j.Data["json"] = "success!"
	j.ServeJSON()
}
...
func (j *PonderacionController) PonderacionDeleteOptions() {
	j.Data["json"] = "success!"
	j.ServeJSON()
}