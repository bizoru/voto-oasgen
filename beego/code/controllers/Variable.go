...
// @Success 200 Variable models.Variable
...
func (j *VariableController) Get() {
	...
	session, _ := db.GetSession()
	if id != "" {
		variable, err := models.GetVariableById(session,id)
		if err != nil {
...
// @Failure 403 body is empty
// @router / [options]
func (j *VariableController) Options() {
	j.Data["json"] = "success!"
	j.ServeJSON()
}
...
func (j *VariableController) VariableDeleteOptions() {
	j.Data["json"] = "success!"
	j.ServeJSON()
}